...
class TypeCheckVisitor(Visitor):
    ...
    def visit_and(self, exp, env):
        ...
        Usage:
            ...
            <class 'bool'>
        """
        exp1 = exp.left.accept(self, env)
        exp2 = exp.right.accept(self, env)
        if exp1 == type(True) and exp2 == type(True):
            return type(True)
        sys.exit("Type error")
    ...
    def visit_add(self, exp, env):
        ...
        exp1 = exp.left.accept(self, env)
        exp2 = exp.right.accept(self, env)
        if exp1 == type(1) and exp2 == type(1):
            return type(1)
        sys.exit("Type error")
    ...
    def visit_ifThenElse(self, exp, env):
        ...
        Usage:
            ...
            <class 'int'> -> <class 'int'>
        """
        exp0 = exp.cond.accept(self, env)
        exp1 = exp.e0.accept(self, env)
        exp2 = exp.e1.accept(self, env)
        if exp0 == type(True):
            return exp1 if exp1 == exp2 else sys.exit("Type error")
        sys.exit("Type error")
    ...
    def visit_let(self, exp, env):
        ...
        Usage:
            ...
            <class 'int'>
        """
        e1 = exp.exp_def.accept(self, env)
        new_env = env.copy()
        new_env[exp.identifier] = e1
    ...
    def visit_fn(self, exp, env):
        ...
        return ArrowType(exp.tp_var, exp.body.accept(self, new_env))
    ...
    def visit_app(self, exp, env):
        ...
        Usage:
            ...
            <class 'int'> -> <class 'int'>
        """
        T1 = exp.function.accept(self, env)
        T = exp.actual.accept(self, env)
        if isinstance(T1, ArrowType) and T1.hd == T:
            return T1.tl
        return T
