...
class Parser:
    ...
    def parse_fn(self):
        while self.cur_token().kind == TokenType.FNX:
    ...
    def parse_factor(self):
        ...
        if token.kind == TokenType.NUM:
            ...
            while self.cur_token_idx < len(self.tokens) and self.cur_token().kind in {TokenType.NUM, TokenType.LPR, TokenType.FNX, TokenType.VAR} :
                entrada = self.parse_fn()
                expr = App(expr, entrada)
            return expr
